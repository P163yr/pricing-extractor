...
- Finish with the answer:  {"thought":"why","action":"done","result":{
      ...
      "price_point": the cheapest PAID entry price as an EXACT USD number — never round (99 stays 99, 9.99 stays 9.99, 29 stays 29), or null,
...
- Report the EXACT advertised price. Never round: a $99 plan is 99 (not 100); keep cents like 9.99 or 19.95. If billing is monthly vs annual, use the monthly entry price unless only annual is shown.
